...
/**
 * Citizen submission form — DESIGN.md §8.
 *
 * Lifted out of the route so the landing page can render above it on the same
 * screen. Nothing about the form itself changed: it is the flow that has been
 * tested end to end and it stays exactly as it was.
 *
...
export function ReportForm() {
  ...
  return (
    <div className="mx-auto w-full max-w-xl px-4 pt-8 pb-16 sm:px-6">
      {/* The heading and the intro now live on the page above this form, which
          owns the #report section. Repeating them here printed "Report a
          problem" twice, one under the other. */}
